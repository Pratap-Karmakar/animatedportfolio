...
export function BackgroundLinesDemo() {
  ...
  return (
    <BackgroundLines className="flex items-center justify-center w-full flex-col px-4 md:px-14">
      ...
      <motion.div
        ...
        className="w-full md:w-1/2 flex flex-col items-start md:pr-8"
      >
        <h2 className="bg-clip-text text-transparent text-left bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-3xl sm:text-4xl lg:text-6xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-start">
        ...
        <motion.p
          ...
          className="w-full text-sm md:text-lg text-neutral-700 dark:text-neutral-400 text-left mt-4"
        >
